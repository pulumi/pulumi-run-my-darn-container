...
func NewGCPInstance(ctx *pulumi.Context,
	...
	err := ctx.RegisterRemoteComponentResource("run-my-darn-container:index:GCPInstance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type GCPInstanceOutput struct{ *pulumi.OutputState }
...
func (o GCPInstanceOutput) ToGCPInstancePtrOutputWithContext(ctx context.Context) GCPInstancePtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v GCPInstance) *GCPInstance {
		return &v
	}).(GCPInstancePtrOutput)
}

type GCPInstancePtrOutput struct{ *pulumi.OutputState }
...
func (o GCPInstancePtrOutput) Elem() GCPInstanceOutput {
