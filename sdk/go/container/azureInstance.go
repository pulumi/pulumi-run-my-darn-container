...
func NewAzureInstance(ctx *pulumi.Context,
	...
	err := ctx.RegisterRemoteComponentResource("run-my-darn-container:index:AzureInstance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type AzureInstanceOutput struct{ *pulumi.OutputState }
...
func (o AzureInstanceOutput) ToAzureInstancePtrOutputWithContext(ctx context.Context) AzureInstancePtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v AzureInstance) *AzureInstance {
		return &v
	}).(AzureInstancePtrOutput)
}

type AzureInstancePtrOutput struct{ *pulumi.OutputState }
...
func (o AzureInstancePtrOutput) Elem() AzureInstanceOutput {
	return o.ApplyT(func(v *AzureInstance) AzureInstance {
		if v != nil {
			return *v
		}
		var ret AzureInstance
		return ret
	}).(AzureInstanceOutput)
}
