...
func NewAWSInstance(ctx *pulumi.Context,
	...
	err := ctx.RegisterRemoteComponentResource("run-my-darn-container:index:AWSInstance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type AWSInstanceOutput struct{ *pulumi.OutputState }
...
func (o AWSInstanceOutput) ToAWSInstancePtrOutputWithContext(ctx context.Context) AWSInstancePtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v AWSInstance) *AWSInstance {
		return &v
	}).(AWSInstancePtrOutput)
}

type AWSInstancePtrOutput struct{ *pulumi.OutputState }
...
func (o AWSInstancePtrOutput) Elem() AWSInstanceOutput {
